...
public class TestFlightDb {
    ...
    public void testToString() {
        ...
        Flight f = new Flight("99A3", new Airport("LGW"), new Airport("DMD"), LocalDateTime.parse("12.07.2016 12:15", formatter),
    ...
    public void testIsConnectingFlight(){
        ...
        Flight f = new Flight("99A3", new Airport("LGW"), new Airport("DMD"), LocalDateTime.parse("12.07.2016 12:15", formatter),
                LocalDateTime.parse("12.07.2016 14:15", formatter), 123.4, 20);
        Flight f1 = new Flight("99A3", new Airport("LGW"), new Airport("DMD"), LocalDateTime.parse("12.07.2016 12:15", formatter),
    ...
    public void testIsEndFlight()
    {
        ...
        Flight f = new Flight("99A3", new Airport("LGW"), new Airport("DMD"), d, d, 123.4, 20);
        f.toString();
